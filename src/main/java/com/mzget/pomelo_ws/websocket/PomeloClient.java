...
import com.mzget.pomelo_ws.exception.PomeloException;
import com.mzget.pomelo_ws.protobuf.ProtoBuf;
import com.mzget.pomelo_ws.protocol.PomeloMessage;
import com.mzget.pomelo_ws.protocol.PomeloPackage;
...
public class PomeloClient extends WebSocketClient {
    ...
    public void request(String route, Object msg, OnDataHandler onDataHandler) throws PomeloException, JSONException {
        reqIdIndex++;
    ...
    private void onData(PomeloPackage.Package decode) throws PomeloException, JSONException {
        ...
        if (onDataHandler != null) {
            onDataHandler.onData(message.getBodyJson());
        } else {
